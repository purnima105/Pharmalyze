...
<html lang="en">
  ...
  <body>
    <form method="post" action="" onsubmit="validate(event)">
      <section id="box">
        <div id="image">
          <img src="/images/signin.gif" alt="" />
        </div>
        <div id="container">
          <h1>Sign In</h1>
          ...
          <input id="buttonn" type="submit" value="Sign In" />
    ...
    <script>
      function validate(event) {
        ...
        if (email == "") {
          ...
          emailError.textContent = "Didn't match the pattern";
          errorCount++;
        }
